...
9. For customer-facing or sales-facing demos, run a UI/UX review before implementation and fold the results into `DESIGN.md` and `tracking/test-cases.md`. `DESIGN.md` must be implementation-grade before frontend coding: include design tokens, typography, component contracts, detailed page implementation specs, UX-flow contracts, state/interaction contracts, responsive rules, accessibility requirements, and visual QA gates.
