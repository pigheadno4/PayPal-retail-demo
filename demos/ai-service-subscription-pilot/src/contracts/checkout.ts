...
export type ReplaceQuoteRequest = Readonly<{ intentId: string; currentQuoteId: string }>;
export type ReplaceQuoteResponse = Readonly<{ review: CheckoutReview; replacementCreated: boolean }>;
