...
- 2026-07-07 local implementation note: selected PayPal and Pay Later now share the same merchant-owned checkout action slot width/fill contract across desktop summary, collapsed drawer, and expanded order sheet through wrapper CSS only; browser rect evidence remains in the Round 3 helper.
