...
2026-07-12 approved next-cycle design: Post-Purchase Operations and Account Experience is the next implementation-planning target. The accepted direction uses route-backed Orders, Lifecycle, Inventory, Webhooks, and Diagnostics Admin workbenches; server-side URL-preserved filters; genuine received webhooks only; persisted sanitized runtime diagnostics; atomic merchant lifecycle updates; and buyer Account order/timeline polish. The complete approved design is recorded in `DEMO.md`, `DESIGN.md`, and the final section of `IMPLEMENTATION_PLAN.md`. Do not begin runtime implementation until the user reviews that written specification and a detailed plan is added to `IMPLEMENTATION_TASKS.md`.

Current M16 planning guide: review the approved Post-Purchase Operations and Account Experience design in `DEMO.md`, `DESIGN.md`, and `IMPLEMENTATION_PLAN.md`; after written-spec approval, add the detailed execution plan to `IMPLEMENTATION_TASKS.md`. Treat `ROUND4_AUTH_MINICART_CHECKOUT_POLISH_PLAN.md`, `mockups/round4-auth-minicart-checkout-polish.html`, `ROUND3_CHECKOUT_PICKUP_DRAWER_PLAN.md`, and the Round 3 section of `CART_CHECKOUT_A_PLUS_SPEC.md` as closed or prior/open evidence context only. Treat `docs/superpowers/plans/2026-07-02-category-pdp-refinement-v6.md`, `docs/superpowers/plans/2026-06-29-category-pdp-reference-polish-v5.md`, and `docs/superpowers/plans/2026-06-18-popmart-reference-polish.md` as historical Category/PDP/reference-polish context only.
