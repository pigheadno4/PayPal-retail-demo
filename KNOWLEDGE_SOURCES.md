...
- Extract conclusions into a demo's `REQUIREMENTS.md`, `DESIGN.md`, `IMPLEMENTATION_PLAN.md`, payment-evidence map, or a `learnings/` entry. Do not paste large wiki sections into any `AGENTS.md`.
